...
const DressCode = ({
    ...
    return (
        <section className="bg-amber-50 p-10 flex flex-col items-center text-center w-full max-w-3xl mx-auto rounded-md">
            ...
            >
                ...
                <div className="mx-4 flex items-center gap-6 px-6 py-2 border border-amber-200 bg-white shadow-md rounded-md">
                    <h2 className="text-blue-800 font-semibold tracking-[0.2em] uppercase text-sm">
            ...
            <motion.h1
                ...
                className="text-5xl md:text-6xl text-blue-800 mb-8"
            ...
            >
                <p className="text-blue-800 text-lg md:text-xl italic leading-relaxed font-light">
